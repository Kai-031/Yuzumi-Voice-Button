...
.vo-btn-bg-light {
  background: linear-gradient(to right, #ff9532 var(--start-percent), #ffb267 var(--progress));
}

.vo-btn-bg-dark {
  background: linear-gradient(to right, #c64a18 var(--start-percent), #fd8d4e var(--progress));
}
